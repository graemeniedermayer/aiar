    ...
    Spawn(model) {
      ...
      player.AddComponent(new render_component.RenderComponent({
        ...
        callback: (mdl, anim, self) => {
          ...
          //   map: mdl.children[0].material.map,
          //   alphaTest: 0.5
          // } );
          // mdl.children[0].customDepthMaterial = depthMesh
          ...
          let weapons = self.Parent.FindEntity('weapons').GetComponent('RenderComponent').group_.children[0].children
          let arrows = self.Parent.FindEntity('arrows').GetComponent('RenderComponent').group_.children[0].children
          ...
          setTimeout(() => {
            weapon.children[0].material.side = THREE.DoubleSide
            weapon.children[0].material.needsUpdate = true
  
            weapon.children[1].material.side = THREE.DoubleSide
            weapon.children[1].material.needsUpdate = true
            
          }, 1000);

          setTimeout(() => {
            arrow.children[0].material.side = THREE.DoubleSide
            arrow.children[0].material.needsUpdate = true
  
            arrow.children[1].material.side = THREE.DoubleSide
            arrow.children[1].material.needsUpdate = true
