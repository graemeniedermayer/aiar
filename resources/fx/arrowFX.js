...
import { SkeletonUtils} from './three-defs.js';
...
`;
  ...
  class ArrowSystem extends entity.Component {
    constructor(params) {
      super();
      this.params_ = params;
      this.Init_();
    ...
    Init_(params) {
      let arrowOrig = self.Parent.FindEntity('arrows').GetComponent('RenderComponent').group_.children[0].children[0]

      let rigidArrow = new basic_rigid_body.CreateArrow(1,1,1,1);
      let arrow = SkeletonUtils.clone(arrow);
